<div align="center">
  ...
  [![Version](https://img.shields.io/badge/Version-v2.0.2-blue?style=for-the-badge)](https://github.com/voidksa/YouTube-Subtitle-Pro/releases)
...
| Feature | Description |
| :--- | :--- |
| **⌨️ Shortcut Fix** | Typing numbers in the settings panel no longer triggers YouTube player shortcuts. |
| **🖱️ UI & Scroll Fix** | Scrolling inside the settings panel no longer scrolls the background, and panel transparency issues outside fullscreen are fixed. |
...
1.  **Download:** Get **`YouTube-Subtitle-Pro-v2.0.2.zip`** from the [Releases](https://github.com/voidksa/YouTube-Subtitle-Pro/releases/latest) page.
